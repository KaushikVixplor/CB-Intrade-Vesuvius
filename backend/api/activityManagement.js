...
module.exports = (app, db) =>
{
    ...
    app.post('/mailA', async (req,res) => {
        ...
        try{
            ...
            var activityData = {"activity": "Sent Mail","description": subject,
            ...
            res.status(200).json({'message':'mail sent successfully','mailresponses': mailresponses}); 
    ...
    app.get('/activity', async (req,res) => {
        ...
        try{
            ...
            res.status(200).json({'message':'ActivityLogs fetched successfully','data': ActivityLogsData}); 

        }
        catch(error){
            console.error("ActivityLogs info fetch error", error);
            res.status(500).json({message:"ActivityLogs info fetch error:: "+error})
        }
    })
